...
{
    // DescribedColumn (one row of the DM's output) moved to Core/ResultShape/DescribedColumn.cs,
    // unchanged, so the pure shape-match/agreement logic can be unit-tested (docs/pivot-plan.md
    // item 13).
